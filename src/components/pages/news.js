        ...
        <div className="bloglist item">
            <div className="post-content">
                ...
                <div className="post-text">
                    <span className="p-tagline">vertical del blog</span>
                    <span className="p-date">Enero 28, 2021</span>
                    <h4><span>Titulo del blog<span></span></span></h4>
                    ...
                    <span className="btn-main">Leer más</span>
                </div>
            </div>
        </div>
      </div>
